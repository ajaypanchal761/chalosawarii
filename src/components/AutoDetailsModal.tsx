...
const AutoDetailsModal = ({ auto, isOpen, onClose }: AutoDetailsModalProps) => {
  ...
  const handlePackageChange = (increment: boolean) => {
    if (increment && packageCount < auto.packagesLeft) {
...
Total Fare: ₹${auto.fare * packageCount}
...
Your travel package has been confirmed. You will receive a confirmation SMS shortly.`);
  ...
  const totalFare = auto.fare * packageCount;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div className="relative">
                <img
                  src={auto.image}
                  alt={auto.packageName}
                  className="w-full h-64 object-cover rounded-lg border border-border"
                />
                <Badge className="absolute top-4 left-4 bg-primary text-primary-foreground">
                  {auto.isPremium ? 'Premium' : 'Standard'}
                </Badge>
                <Badge className="absolute top-4 right-4 bg-secondary text-secondary-foreground">
                  {auto.isGuided ? 'Guided' : 'Self-Guided'}
                </Badge>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-muted-foreground">{auto.packageName}</p>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <Button
                    ...
                    disabled={packageCount >= auto.packagesLeft}
                    className="w-10 h-10 p-0"
                  >
              ...
              <div className="mt-4 p-4 bg-blue-50 rounded-lg">
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    <p className="text-sm text-gray-600">₹{auto.fare} × {packageCount}</p>
