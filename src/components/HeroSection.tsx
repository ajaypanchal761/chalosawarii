  ...
  return (
    <section className="relative min-h-[600px] flex flex-col bg-white">
            ...
            <Card className={`max-w-6xl px-6 pt-4 pb-6 bg-white/95 backdrop-blur-md shadow-2xl border-0 rounded-2xl -mt-10 ml-[450px] transition-all duration-1000 ease-out delay-500 ${
              ...
              <div className={`grid gap-6 items-end -mt-2 ${activeService === "roundTrip" ? "grid-cols-5" : "grid-cols-4"}`}>
                ...
                <div className="space-y-2 relative group">
                  ...
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 w-7 h-7 bg-blue-100 rounded-full flex items-center justify-center z-10 transition-all duration-300 group-hover:bg-blue-200 group-hover:scale-110">
                      <Search className="w-4 h-4 text-blue-600 transition-all duration-300 group-hover:rotate-12" />
                    </div>
                    <Input
                ...
                <div className="space-y-2 relative group">
                  ...
                  <div className="relative">
                    <div className="absolute left-4 top-1/2 transform -translate-y-1/2 w-7 h-7 bg-green-100 rounded-full flex items-center justify-center z-10 transition-all duration-300 group-hover:bg-green-200 group-hover:scale-110">
                      <MapPin className="w-4 h-4 text-green-600 transition-all duration-300 group-hover:scale-110" />
                    </div>
                    <Input
      ...
      <div className="block md:hidden flex-1 flex flex-col">
        ...
        <div className={`flex justify-center space-x-4 p-4 border-b border-border transition-all duration-1000 ease-out delay-200 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-8'
        }`}>
          <Button 
            variant={activeService === "oneWay" ? "default" : "outline"}
        ...
        {/* Main Content */}
        <div className={`flex-1 p-4 space-y-4 pb-20 transition-all duration-1000 ease-out delay-400 ${
          isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
        }`}>

          {/* Main Booking Card */}
          <Card className="p-4 bg-background shadow-sm rounded-xl border border-border transition-all duration-300 hover:shadow-lg hover:scale-[1.02]">
            {/* From Field */}
            <div className="mb-4 relative group">
              <div className="relative">
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 w-7 h-7 bg-primary/20 rounded-full flex items-center justify-center z-10 transition-all duration-300 group-hover:bg-primary/30 group-hover:scale-110">
                  <Search className="w-4 h-4 text-primary transition-all duration-300 group-hover:rotate-12" />
                </div>
                <Input
                  value={fromLocation}
                  onChange={(e) => setFromLocation(e.target.value)}
                  className="pl-14 h-14 border-border/50 bg-background/90 backdrop-blur-sm text-lg font-medium rounded-xl transition-all duration-300 hover:border-primary/50 hover:shadow-md"
              ...
              <div className="absolute right-5 top-full transform -translate-y-3 z-20">
                <Button
                  variant="outline"
                  size="icon"
                  className="rounded-full border-border/50 hover:bg-primary/10 hover:border-primary transition-all duration-300 w-10 h-10 shadow-md bg-white hover:scale-110 hover:rotate-180"
                  onClick={handleSwapLocations}
                >
            ...
            <div className="mb-6 relative group">
              <div className="relative">
                <div className="absolute left-4 top-1/2 transform -translate-y-1/2 w-7 h-7 bg-primary/20 rounded-full flex items-center justify-center z-10 transition-all duration-300 group-hover:bg-primary/30 group-hover:scale-110">
                  <MapPin className="w-4 h-4 text-primary transition-all duration-300 group-hover:scale-110" />
                </div>
                <Input
                  value={toLocation}
                  onChange={(e) => setToLocation(e.target.value)}
            ...
            <div className="mb-4 group">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  <Calendar className="w-5 h-5 text-muted-foreground transition-all duration-300 group-hover:text-primary group-hover:scale-110" />
                  <span className="text-sm font-medium text-foreground transition-all duration-300 group-hover:text-primary">Pickup Date</span>
                </div>
              </div>
              <div className="relative">
                <Input
                  ...
                  value={departureDate}
                  onChange={(e) => setDepartureDate(e.target.value)}
                  className="h-12 border-border rounded-lg transition-all duration-300 hover:border-primary/50 hover:shadow-md"
                />
              </div>
            </div>
             ...
             <div className="mb-4 group">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center space-x-2">
                  <Calendar className="w-5 h-5 text-muted-foreground transition-all duration-300 group-hover:text-primary group-hover:scale-110" />
                  <span className="text-sm font-medium text-foreground transition-all duration-300 group-hover:text-primary">Pickup Time</span>
                </div>
              </div>
              <div className="relative">
                <Input
            ...
            {activeService === "roundTrip" && (
              <div className="mb-4 group animate-in slide-in-from-right duration-500">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-2">
                    <Calendar className="w-5 h-5 text-muted-foreground transition-all duration-300 group-hover:text-primary group-hover:scale-110" />
                    <span className="text-sm font-medium text-foreground transition-all duration-300 group-hover:text-primary">Return Date</span>
                  </div>
                </div>
                <div className="relative">
                  <Input
          ...
          <Button 
            className="w-full h-14 bg-primary text-primary-foreground hover:bg-primary/90 rounded-xl shadow-lg font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:-translate-y-1 mt-4"
            onClick={handleSearch}
          >
            <Search className="w-5 h-5 mr-3 transition-all duration-300 group-hover:rotate-12" />
            Search
