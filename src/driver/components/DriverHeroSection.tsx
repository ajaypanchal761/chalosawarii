...
// Marquee Component for Driver-specific announcements
          ...
          <div className="grid grid-cols-2 gap-3">
            <Card className="bg-white shadow-sm border-0 rounded-lg">
              <div className="p-4 text-center">
                ...
                <h3 className="text-lg font-bold text-gray-800">2</h3>
            ...
            <Card className="bg-white shadow-sm border-0 rounded-lg">
              <div className="p-4 text-center">
                ...
                <h3 className="text-lg font-bold text-gray-800">₹2,450</h3>
            ...
            <Card className="bg-white shadow-sm border-0 rounded-lg">
              <div className="p-4 text-center">
                ...
                <h3 className="text-lg font-bold text-gray-800">156</h3>
